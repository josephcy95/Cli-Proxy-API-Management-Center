...
const buildPrefixProxyUpdatedText = (
  ...
  if (patch.disable_cooling !== undefined) next.disable_cooling = patch.disable_cooling;
  ...
  if (patch.excluded_models !== undefined) next.excluded_models = patch.excluded_models;
